    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE code='{$_GET['reset']}'")) > 0) {
        if (isset($_POST['submit'])) {
            ...
            if ($password === $confirm_password) {
                ...
                $msg = "<div class='alert alert-danger'>Password changed successfully.</div>";
            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <p>Enter Company new password below to update your account. 🔒</p>

                        <?php echo $msg; ?>
                        <form action="" method="post">
                            <input type="password" class="password" name="password" placeholder="Enter New Password" pattern="^(?=.*[a-zA-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$" title="Password should contain at least one character, one number, one special character, and be at least 8 characters long" required>
