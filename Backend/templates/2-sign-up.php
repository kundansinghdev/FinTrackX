...
if (isset($_POST['register'])) {
    // Storing image path in the database
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($user_id !== false) {
            ...
            header('Location: http://localhost/ExpenseManagement/Backend/index.php');
            exit();
        }
    }
}
...
<body>
    ...
    <div class="container">
        ...
        <form action="2-sign-up.php" method="post" id="form" onsubmit = "return validate()" enctype="multipart/form-data">
            ...
            <label for="imageUpload" class="user-pic-btn" style="cursor: pointer;">Add Logo</label>
            ...
            <div class="group">
                <div class="form-control">
                    ...
                    <input class="fname" onkeypress="return (event.charCode > 64 && event.charCode < 91) || 
                    (event.charCode > 96 && event.charCode < 123)" 
                    type="text" name="full_name" id="fullname" minlength="2" maxlength="30" 
                ...
                <div class="form-control">
                    ...
                    <input type="password" name="password" id="password" placeholder="Password" minlength="6" maxlength="30" autocomplete="on" 
                    pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{6,30}$" 
                    title="Password must be between 6 and 30 characters long and contain at least one letter and one number" 
                    required>
